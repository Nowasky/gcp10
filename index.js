...
// Config
const PORT = 3001;
const HOSTNAME = "https://49cceeb0fcac.ngrok.io";//"http://localhost:3001";//:" + PORT;
const CHARSET = ".0123456789abcdefghijklmnopqrstuvwxyz";
const PREFIX = '"';
const LOG = 4;
const DEBUG = true;
const DELAY = '0.5s';
const DURATION = '5.5s';//'1.5s';
const WIDTH = '42px'; //chars * 7
const DEL = '_';
...
function genResponse (res, ttl, chars) {
    ...
    var css =
        ...
        genInjection('.line', n, WIDTH, DELAY, DURATION);
    res.set({
...
app.get("/font/:prefix/:charsToLigature", (req, res) => {
    ...
    res.set({
        'Cache-Control': 'public, max-age=600',
        'Content-Type': 'font/woff',//'application/x-font-woff',
